...
{/*
        debe de mostrar una ventana con la opcion de meter correo y password y confirmar password (el front verifica si coinciden) (esto no es mas que una peticion post al endpoint de users),
        si todo sale bien reload a la ventana de inicio de sesion
*/}
